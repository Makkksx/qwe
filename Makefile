all: menu.o index_first_negative.o index_last_negative.o sum_between_negative.o sum_before_and_after_negative.o
	gcc -o menu menu.o index_first_negative.o index_last_negative.o sum_between_negative.o sum_before_and_after_negative.o
menu.o: index_first_negative.h index_last_negative.h sum_between_negative.h
	gcc -c menu.c
